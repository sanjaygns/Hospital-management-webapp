...
<title>View Waiting Patients</title>
...
var a=document.forms["getpid"]["pid"].value;
...
<div class="welcomtext" id="welcometext">
  <h2 align="right" class="style2">Patients Waiting for you  -  Usha Eye Care </h2>
  <h1 align="center">&nbsp;</h1>
  <div align="right">
<h4>&nbsp;</h4>
<h4>&nbsp;</h4>
...
<table width="700" height="100" border="2" cellpadding="5" cellspacing="5">
 ...
 ?>
   <tr>
    <form name="getpid"  onSubmit="return validateForm()" action="attend_patient.php" method="post">
    <td class="style13"><span class="style10">Choose Patient ID to attend </span></td>
	<?php
$qry="select * from opvisit where did = '$my' and prescription = ''";
