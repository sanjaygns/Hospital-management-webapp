...
var a=document.forms["patient"]["pid"].value;
  ...
  if (a=="Default" || a=="")
  {
  alert("Choose a valid Patient ID");
  return false;
  }
...
<div class="welcomtext" id="welcometext">
  <h2 align="right" class="style2">Patient List  -  USHA Eye Hospitals </h2>
  <h1 align="center">&nbsp;</h1>
  <div align="right">
<h4>&nbsp;</h4>
<h4>&nbsp;</h4>
...
<table width="700" height="100" border="2" cellpadding="5" cellspacing="5">
 ...
 ?>
  <tr>
  	  <td class="style13"><span class="style10"><?php echo $member['name']; ?></span></td>
	...
	<td class="style13"><span class="style10"><?php echo $member['occupation']; ?></span></td>
	<td class="style13"><span class="style10"><?php echo $member['fhname']; ?></span></td>
 ...
 ?>
   <tr>
    <form name="patient"  onSubmit="return validateForm()" action="patient_detail.php" method="post">
    <td class="style13"><span class="style10">Choose Patient ID for details </span></td>
	<?php
...
<?php
 ...
 ?>
        ...
        <option><?php echo $member['pid'] ?></option>
<?php 
} }
 } 
 ?>
