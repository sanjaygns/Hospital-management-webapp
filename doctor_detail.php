...
<p>&nbsp;______________________________________________________________________________________________________________________________________________________</p>
 ...
 <?php
  $data = "select * from doctor where did='$doc'";
...
<table width="200" height="100" border="2" cellpadding="5" cellspacing="5">
	<tr >
    <td align="center" class="style13"><span class="style10">Doctor Details </span></td>
	<?php 
	if($_SESSION['admin']) { ?>
	 <form name="patient"  onSubmit="return validateForm()" action="doctor_edit.php" method="post">
	 <input name="pid" type="hidden" value="<?php echo $doc ?>" />
    ...
    <td class="style13"><span class="style10"><?php echo $pat['first_name']; ?></span></td>
	</tr>
  
    <tr>
    <td class="style13"><span class="style10">Last name </span></td>
    <td class="style13"><span class="style10"><?php echo $pat['last_name']; ?></span></td>
	</tr>
    ...
    <td class="style13"><span class="style10"><?php echo $pat['speciality']; ?></span></td>
	</tr>
    ...
    <td class="style13"><span class="style10"><?php echo $pat['emailid']; ?></span></td>
	</tr>
