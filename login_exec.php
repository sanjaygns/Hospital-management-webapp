   ...
   $_SESSION['admin']=0;
   $_SESSION['super']=0;
 $_SESSION['SESS_FIRST_NAME'] = 0;
    $_SESSION['SESS_LAST_NAME'] = 0;
	$s1='admin';
	$s2= 'usha';
    $st1 = 'superadmin';
	$st2 = 'hospital';
...
<?php
  ...
  else if( $username == $st1 and $password== $st2)
     {
	 $a = 1;
		$_SESSION['admin'] = $a;
		$_SESSION['super'] = $a;
    ?>
  <script type="text/javascript">
    if(!alert("Wellcome Super admin : redirectring to owner area")) document.location = 'superadminhome.php';
    exit();
  </script>
<?php
    ...
    //Create query
    $qry="SELECT * FROM doctor WHERE did='$username' AND pass='$password'";
    ...
    $_SESSION['SESS_MEMBER_ID'] = $member['did'];
